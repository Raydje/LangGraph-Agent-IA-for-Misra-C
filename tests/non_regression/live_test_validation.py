...
async def run_live_tests():
    ...
    print(
        f"Tokens           : {result_compliant.get('total_tokens')} (Cost: ${result_compliant.get('estimated_cost', 0):.6f})\n"
    )
    ...
    print(
        f"Tokens           : {result_violating.get('total_tokens')} (Cost: ${result_violating.get('estimated_cost', 0):.6f})\n"
    )
    ...
    print(
        f"Tokens           : {result_critique.get('total_tokens')} (Cost: ${result_critique.get('estimated_cost', 0):.6f})\n"
    )
